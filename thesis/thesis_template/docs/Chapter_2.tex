...
\indent Dla zbudowanego kernela zdefiniowano bufory:
\begin{itemize}
...
graficznej, linerange=303-325, firstnumber=307]{viterbi_source/Viterbi.cpp} 

%create buffers
\lstinputlisting[language={C++}, label={lst:opencl_buffers}, caption=Tworzenie buforów wymiany danych, linerange=326-344, firstnumber=326]{viterbi_source/Viterbi.cpp} 

%read results
\lstinputlisting[language={C++}, label={lst:opencl_detect}, caption=Wyznaczenie współrzednych linii, linerange=352-364, firstnumber=352]{viterbi_source/Viterbi.cpp} 


%-------!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!---------
%
%   Popraw ryysunek dla C++11 - przy bloku warunkowym dodaj T/N do strzałek
%
%--------!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!---------
