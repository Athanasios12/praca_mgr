...
\code{CImg}. Reprezentowane przez obiekty \code{Cimg<T>}, dane pikseli zdjęcia były kopiowane do
...
\end{enumerate}
Informacje o intensywności pikseli obrazu pobierane są używając składowej klasy \code{Viterbi} \code{const unsigned char *m\_img}.
\clearpage
...
\lstinputlisting[language={C++}, label={lst:viterbi_serial_init}, caption=Inicjalizacja zmiennych, linerange=221-236, firstnumber=222]{viterbi_source/Viterbi.cpp} 

\lstinputlisting[language={C++}, label={lst:viterbi_serial_loop}, caption=Główna pętla programu, linerange=237-290, firstnumber=237]{viterbi_source/Viterbi.cpp} 

%-----------------------------
%%
%   Dodac zdjęcie ze zmiennymi z programu pokazujace działanie algorytmu,
%   podobnie dla reszty - threads, opencl
%%
%-----------------------------------------
\begin{figure}[h]
...
\lstinputlisting[language={C++}, label={lst:viterbi_threads}, caption=Wielowątkowa implementacja algorytmu detekcji linii, linerange=389-422, firstnumber=389]{viterbi_source/Viterbi.cpp} 
...
%kernel opencl
\lstinputlisting[language={C}, label={lst:opencl_kernel}, caption=Kernel do detekcji linii, linerange=46-127, firstnumber=1]{viterbi_source/viterbi_kernel.cl} 

%ładowanie kernela
\lstinputlisting[language={C++}, label={lst:opencl_load_kernel}, caption=Metoda tworząca kernel OpenCL, linerange=25-64, firstnumber=25]{viterbi_source/Viterbi.cpp} 

%viterbi cols opencl initialization zrobic odniesienie do załącznika - funkcja initialize CL z 
%pliku opencl_viterbi.cpp

%memory check
\lstinputlisting[language={C++}, label={lst:opencl_cols}, caption=Sprawdzanie dostępnej pamięci karty 
graficznej, linerange=307-329, firstnumber=307]{viterbi_source/Viterbi.cpp} 

%create buffers
\lstinputlisting[language={C++}, label={lst:opencl_cols}, caption=Tworzenie buforów wymiany danych, linerange=330-350, firstnumber=330]{viterbi_source/Viterbi.cpp} 

%read results
\lstinputlisting[language={C++}, label={lst:opencl_cols}, caption=Wyznaczenie współrzednych linii, linerange=358-369, firstnumber=358]{viterbi_source/Viterbi.cpp} 
