...
\lstinputlisting[language={C++}, label={lst:viterbi_serial_init}, caption=Inicjalizacja zmiennych, linerange=222-237, firstnumber=222]{viterbi_source/Viterbi.cpp} 
...
\begin{figure}[h]
\includegraphics[scale=0.8]{threads_viterbi}
\caption{Schemat działania algorytmu szeregowego}
