...
%	\begin{figure}[h]
%	\includegraphics[width=0.5\textwidth, inner]{imgs/mobile_robot}
%	\caption{Przykład wizyjnej identyfikacji\protect\cite{Machine_Vision_Intro}}
%	\label{fig:identyfikacja}
%	\end{figure}
...
Stosowane są wtedy najczęściej układy wyposażone mikroprocesory, np. rodzina procesorów ARM oraz x86 firm Intel i AMD. Obecne modele są najczęściej wielordzeniowe o taktowaniu nawet powyżej 1GHz
\cite{ARM_catalog_NXP_Broadcom_Qualcomm} \cite{Intel_microprocessors}, \cite{AMD microprocessors}.
...
sprzętową implementację algorytmów. \cite{FPGA_book}. 
	
	%układ fpga
%	\begin{figure}[h]
%	\includegraphics[width=0.5\textwidth, inner]{imgs/fpga}
%	\caption{Przykład wizyjnej identyfikacji\protect\cite{FPGA_book}}
%	\label{fig:identyfikacja}
%	\end{figure}

	%procesor arm/intel amd
%	\begin{figure}[h]
%	\includegraphics[width=0.5\textwidth, inner]{imgs/microprocessor}
%	\caption{Przykład wizyjnej identyfikacji\protect\cite{Machine_Vision_Intro}}
%	\label{fig:identyfikacja}
%	\end{figure}
...
%avr microcontroller
%	\begin{figure}[h]
%	\includegraphics[width=0.5\textwidth, inner]{imgs/microcontroller}
%	\caption{Przykład wizyjnej identyfikacji\protect\cite{Machine_Vision_Intro}}
%	\label{fig:identyfikacja}
%	\end{figure}
...
%pododawać zdjęcia dla tego rozdziału
podrozdział 2 
