...
\cite{POSIX_Butenhof}\cite{C_King}
W celu deklaracji muteksa wykorzystywane jest makro \code{PTHREAD\_MUTEX\_INITIALIZER}. Jeśli muteks jest używany jako
...
Niezbędne jest po zakończeniu używania muteksa, zwolnienie zaalokowanej pamięci, poprzez wykorzystanie funkcji \code{pthread\_mutex\_destroy}. %dokończyć i dopisać porównanie strumienia wyjścia
%dla poprzedniego przykladu i tego z mutexem
\\
