...
Wywołanie \code{pthread\_create} oprócz rozpoczęciu nowego wątku zwraca identyfikator
\code{pthread\_t}, który będzie wykorzystywany do odnoszenia się do stworzonego wątku.
Wątek zostaje zakończony jeśli wykona wszystkie instrukcje swojej funkcji lub jeśli wywoła procedurę \code{pthread\_exit}. Poniższy kod przedstawia przykład tworzenia nowego wątku.

\lstinputlisting[language=C, caption=Przykład tworzenia i uruchamiania wątków]{code_snippets/posix_example_0.c} 
